...
public class ExploreIndex extends SeleniumInit{
	...
	public void guestUserPurchasePlan() throws Exception {
		...
		ArrayList<String> planDetails = TestData.getColumnData("ReadDataFromExcel/MTN.xlsx", "Plan", "TC_01");
		...
		String languageToExecute= TestData.getColumnData("ReadDataFromExcel/MTN.xlsx", "URL", "Language").get(0);
